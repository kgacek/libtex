...
2. Co nie dzia³a
   ...
   + Nie ma mo¿liwo¶ci wyboru jêzyka
...
osi±gniêcia efektu wizualnego. St±d obecno¶æ w dystrybucji plików
...
5. Do zrobienia
   ...
   + Font u¿ywany do wy¶wietlania adresów poleceniem \url{}
...
5. Pliki z archiwum nale¿y rozpakowaæ we "w³a¶ciwe miejsce". Uk³ad
...
texmf-local. Mo¿na (na w³asn± odpowiedzialno¶æ) skopiowaæ
(rozpakowaæ w) do texmf.

Nastêpnie nale¿y od¶wie¿yæ zawarto¶æ bazy danych.

5. Pakiet definiuje temat pwr; u¿ycie \usetheme{pwr}

6. Do zrobienia:
+ parametryzacja (pasek po lewej na stronie tytu³owej, wersja
angielska, obecno¶æ paska nawigacji, rozdzielczo¶æ ekranu).
+ fonty w \url!
+ wszechstronne testy
+ dokumentacja
...
parametrami okre¶laj±cymi ,,ozdobê'' na stronie tytu³owej (pasek)
oraz jêzyk (lang).
...
powinny byæ takie, ¿eby dobrze mie¶ci³ siê w polu o szeroko¶ci 23 mm
i wysoko¶ci 73 milimetrów (plik bêdzie przeskalowany do tych
wymiarów!)
...
Parametr lang mo¿e przyjmowaæ warto¶ci pl lub en co spowoduje
...
Dodana dodatkowa opcja fonty mog±ca pzyj±æ dwie warto¶ci jtrr i trebuchet
w zalezno¶ci od sposobu zainstaloowania font podstawowego (,,rêczna'' -- jtrr
...
W koñcu szablon strony tytu³owej honoruje warto¶æ opcji acpectratio, który 
mo¿e przyjmowaæ warto¶ci
43   -- 4x3 (standard)
54   -- 5x4
169  -- 16x9
1610 -- 16x10
